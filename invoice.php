...
<li class="breadcrumb-item"><a href="#">INOVOICE</a></li>
...
<div class="hk-pg-header">
 <h4 class="hk-pg-title"><span class="pg-title-icon"><span class="feather-icon"><i data-feather="file"></i></span></span>VIEW INCOICE</h4>
                </div>
                <!-- /Title -->
...
<th width="5%" style="color:red;">QUANTITY</th>
<th width="10%" style="color:red;">UNIT PRICE</th>
<th width="10%" style="color:red;">PRICE</th>
