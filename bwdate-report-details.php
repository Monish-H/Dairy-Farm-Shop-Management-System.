...
<li class="breadcrumb-item active" aria-current="page">B/W DATES REPORT DETAILES</li>
                </ol>
            </nav>
            <!-- /Breadcrumb -->
                                        ...
                                        <table id="datable_1" class="table table-hover w-100 display pb-30">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th style="color: red;">INVOICE NUMBER</th>
                                                    <th style="color: red;">CUSTOMER NAME</th>
                                                    <th style="color: red;">CUSTOMER CONTACT NO.</th>
                                                    <th style="color: red;">PAYMENT MODE</th>
                                                    <th style="color: red;">INVOICE GEN. DATE</th>
