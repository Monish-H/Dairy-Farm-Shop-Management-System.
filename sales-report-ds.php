...
<li class="breadcrumb-item active" aria-current="page">Sales Report</li>
            ...
            <div class="container">
                ...
                <div class="hk-pg-header">
                    <h4 class="hk-pg-title"><span class="pg-title-icon"><span class="feather-icon"><i data-feather="external-link"></i></span></span>SALES DATE REPORT SELECTION</h4>
                </div>
                <!-- /Title -->
...
<label for="validationCustom03" style="color: red;">FROM DATE</label>
...
<div class="form-row">
<div class="col-md-6 mb-10">
<label for="validationCustom03" style="color: red;">TO DATE</label>
